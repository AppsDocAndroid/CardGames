...
public class BlackjackInsuranceTask extends AsyncTask<String,String,GameAction> {
    ...
    protected GameAction doInBackground(final String... params) {
        return insurance(params[0], params[1]);
    }

    private GameAction insurance(final String gameId, final String bet) {
        String responseString = WebManager.post("http://cg.otasyn.net/game/blackjack/action/insurance/json",
